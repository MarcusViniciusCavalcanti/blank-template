...
import { BreakpointsService, DEFAULT_MEDIA_BREAKPOINTS } from './breakpoints.service';
...
describe('breakpoint-service' , () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        { provide: MEDIA_BREAKPOINTS, useValue: DEFAULT_MEDIA_BREAKPOINTS },
        BreakpointsService,
      ]
    });
  });
  ...
  beforeEach(async(inject(
    [BreakpointsService],
    (newBreakPointService) => {
      breakpointService = newBreakPointService;
    }
  )));
